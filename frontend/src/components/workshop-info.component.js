...
import WorkshopHero from '../images/workshop-hero.png';
import BulletCheck from '../icons/bulletpoints-checkmark.svg';
        ...
        <div id="workshop-info" className="landing2">
            <div className="landing2-content">
                <div>
                    ...
                    <img className="hero-image" src={WorkshopHero} />

                    <h2 className="workshop-headline"><span className="underline">Du</span> kannst etwas bewegen. Sei es auf der Straße, in der Politik oder an deinem Schreibtisch.</h2>
                    ...
                    <p style={{ textAlign: 'center', marginBottom: '3em' }}>Für jede Anmeldung wird <span className="underline">ein Baum gepflanzt</span>.</p>

                    <h2 className="uppercase" style={{ marginBottom: '0' }}>Wir suchen <span className="underline">dich*</span> für einen kreativen workshop.</h2>
                    <p style={{ marginTop: '0.3em' }}>*im Alter zwischen 16 und 19 Jahren</p>
                    <ul>
                        <li><img src={BulletCheck} /><b>Entdecke deine Stärken.</b></li>
                        <li><img src={BulletCheck} /><b>Lerne professionelle Methoden, um nachhaltige Lösungen zu finden.</b> </li>
                        <li><img src={BulletCheck} /><b>Arbeite in einem engagierten und kreativen Team.</b></li>
                        <li><img src={BulletCheck} /><b>Hilf mit, an einer idealen Zukunft zu arbeiten</b></li>
                    </ul>
                    <p>
                        <b>Kostenlos</b> anmelden und an einem <b>2-tägigen Intensiv-Workshop</b> zum Thema »Nachhaltigkeit» teilnehmen.<br />
                    </p>

                    <h2 className="uppercase" style={{ marginTop: '2em', marginBottom: '0' }}>Warum kostenlos Teilnehmen?</h2>
                    <p style={{ marginTop: '0.3em' }}>Dieser Workshop ist <b>praktischer Teil</b> einer <b>Bachelorarbeit im Bereich Design</b>. Deswegen fallen weder Kosten noch Werbung an, sondern wird allein durch deine Teilnahme vergütet.</p>
                    ...
                    <div className="signup-container">
                        ...
                        <button onClick={SignupClicked} style={{ marginTop: "1.4em", marginBottom: '2em', display: 'initial' }}>Anmeldung abschicken</button>
                    </div>
                    ...
                    <h2 style={{ marginTop: '2em' }}>Mehr Informationen:</h2>

                    <Accordion allowZeroExpanded={true}>
                        <AccordionItem>
                            <AccordionItemHeading>
                                <AccordionItemButton>
                                    <h3>Über den Workshop</h3><img src={Chevron} />
                                </AccordionItemButton>
                            </AccordionItemHeading>
                            <AccordionItemPanel>
                                <p>
                        ...
                        <AccordionItem>
                            <AccordionItemHeading>
                                <AccordionItemButton>
                                    <h3>Als Team arbeiten</h3><img src={Chevron} />
                                </AccordionItemButton>
                            </AccordionItemHeading>
                            <AccordionItemPanel>
                                <p>
                       ...
                       In unserem Sprint bilden wir ein Team aus <b>maximal acht Leuten</b> (Mentor miteingeschlossen, deswegen nur 7 Plätze, auf die man sich bewerben kann). Wichtigste Voraussetzung ist, dass du <b>zwischen 16 und 19 Jahren alt</b> bist und Lust hast etwas Neues auszuprobieren. <br />
                        ...
                        <AccordionItem>
                            <AccordionItemHeading>
                                <AccordionItemButton>
                                    <h3>Korona-Konform</h3><img src={Chevron} />
                                </AccordionItemButton>
                            </AccordionItemHeading>
                            <AccordionItemPanel>
                                <p>
                        ...
                        <AccordionItem>
                            <AccordionItemHeading>
                                <AccordionItemButton>
                                    <h3>Minderjährig?</h3><img src={Chevron} />
                                </AccordionItemButton>
                            </AccordionItemHeading>
                            <AccordionItemPanel>
                        ...
                        <AccordionItem>
                            <AccordionItemHeading>
                                <AccordionItemButton>
                                    <h3>Über uns</h3><img src={Chevron} />
                                </AccordionItemButton>
                            </AccordionItemHeading>
                            <AccordionItemPanel>
                                <p>
